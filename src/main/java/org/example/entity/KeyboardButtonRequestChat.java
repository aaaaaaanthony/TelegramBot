...
public class KeyboardButtonRequestChat {
    ...
    /**
     * A signed 32-bit identifier of the request, which will be received back in the ChatShared object. Must be unique within the message.
     */
    private Integer requestId;

    /**
     * Optional. Pass True to request a channel chat, pass False to request a group or a supergroup chat.
     */
